                            ...
                            <div id="collapseOne2" class="panel-collapse collapse in"
                                ...
                                <div class="panel-body">
                                    <div class="panel-group" id="accordion3" role="tablist"
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading" role="tab"
                                                 id="headingOne21{{$category->id}}">
                                                <h4 class="panel-title">
                                                    <a role="button"
                                                       data-toggle="collapse"
                                                       data-parent="#accordion3"
                                                       href="#collapseOne21{{$category->id}}"
                                                       aria-expanded="true"
                                                       aria-controls="collapseOne21{{$category->id}}">
                                                        {{$category->title}}
                                                    </a>
                                                </h4>
                                            </div>
                                            <div id="collapseOne21{{$category->id}}"
                                                ...
                                                <div class="panel-body">
                                                    @php($products=\App\Product::where('category_id',
                                                    $category->id)->where('is_active',1)->get())
                ...
                <div class="panel-body">
                    <form class="text-dark" id="menu-top4">
                        ...
                        @foreach($colors as $color)
                            <label class="form-check">
                                <input class="form-check-input" type="checkbox" value="">
                                <span class="color" style="color: {{$color->color}}"> <i class="fas
                                    fa-circle"></i></span>
                                <span class="form-check-label">{{$color->color}}</span>
                            </label>
                        @endforeach
                        <button class="btn btn-pink">OK</button>
                    </form>
