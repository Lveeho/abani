...
<main>
	<div class="container-fluid"><section id="BCproducts" class="row BC">
		...
		<section id="checkout" class="row">
			<div class="col">
				<h2 class="text-uppercase text-dark py-5 text-center ">Order confirmed</h2>
				<div class="mb-5 text-dark">
					<div class="text-center">
						<div class="mb-5 mx-auto text-white">
							<i class="fas fa-check-circle fa-3x text-pink"></i>
						</div>
						<h3 class="mb-3 ">Thank you, XXX. Your order is confirmed.</h3>
						<p class="text-muted mb-5">Your order hasn't shipped yet but we will send you ane email when it does.</p>
						<p> <a href="404.blade.php" class="btn btn-pink">View or manage your order</a></p>
					</div>
				</div>
			</div>
		</section>
