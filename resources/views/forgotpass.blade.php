				...
				<div class="row pt-5">
					<div class="col-lg-4 col-md-6 m-auto ">
						<div class="mb-2 text-white text-center">
							<h2 class="text-uppercase shadow pb-2">Recover account</h2>
						</div>
						<div class="mb-2">
							<form method="post">
								...
								<div class="form-group">
									<button class="btn btn-pink btn-block" type="submit">Reset password
									</button>
								</div>
							</form>
						</div>
						<div class="mb-2 text-white">
							<p class="text-center"><small > We will send you an email with a link for reset.</small></p>
						</div>
					</div>
				</div>
			</div>
