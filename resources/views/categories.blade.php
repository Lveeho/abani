...
<head>
	<meta charset="UTF-8">
	<meta name="description" content="global categories">
	<meta name="keywords" content="categories page">
			...
			<div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
				<div class="row">
					...
					<div class="col-lg-9 pl-lg-5 pr-0">
						<h1 class="titelnav text-uppercase pt-lg-5">Sale</h1>
						<img src="assets/images/salebigpic.jpg" class="img-fluid mb-4 w-100" alt="Responsive image">
									...
									<div class="card mr-lg-3 w-100 cont">
										<div class="hartje">
											...
											<div class="middle d-flex ">
												...
												<a href="template.html" class="btn btn-look flex-fill" role="button">
													<i class="text-white fas fa-search py-2 px-2"></i>
												</a>
											</div>
